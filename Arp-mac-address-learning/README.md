...
## Procedure Summary
1. Verify ARP tables on PCs are empty
2. Verify MAC address tables on switches are empty
3. Send ping from PC1 to PC3
4. Observe traffic using Packet Tracer Simulation Mode
5. Generate additional pings to populate MAC tables
6. Verify learned MAC addresses using show commands
7. Clear MAC tables and re-test
